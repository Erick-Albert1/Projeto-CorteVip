...
export default function Planos({premium}: PlanosProps){
  ...
  return(
    <>
      <Head>
        <title>CorteVIP - Sua assinatura Premium</title>
      </Head>
      <Sidebar>
        ...
        <Flex color="white" pb={8} maxW="780px" w="100%" direction="column" align="flex-start" justify="flex-start">
          ...
          <Flex gap={4} w="100%" flexDirection={isMobile ? "column" : "row"}>
              <Flex rounded={4} p={2} flex={1} bg="barber.400" flexDirection="column">
                ...
                <Text fontWeight="medium" ml={4} mb={2}>- Criar apenas 4 modelos de corte.</Text>
